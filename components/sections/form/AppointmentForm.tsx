  ...
  if (status === "success") {
    return (
      <div className="max-w-3xl mx-auto text-center py-20 bg-secondary/5 rounded-[2.5rem] border border-foreground/5 px-8">
        ...
        <h3 className="text-3xl font-black uppercase tracking-tighter mb-4 text-foreground">
          Request Sent
        </h3>
        <p className="text-secondary/70 text-lg mb-8">
          We&apos;ve received your appointment request. We will contact you
          ...
          <form onSubmit={handleSubmit} className="grid gap-8">
            ...
            {availableServices.length > 0 && (
              <div className="grid gap-3">
                ...
                <select
                  ...
                  required
                  className="w-full bg-background border-2 border-secondary/10 rounded-2xl p-4 focus:border-primary outline-none transition-all text-lg appearance-none"
                >
            ...
            <div className="grid gap-3">
              ...
              <p className="text-[11px] text-secondary/50 font-medium italic mt-1 ml-1">
                * This is a tentative request. We will confirm final
