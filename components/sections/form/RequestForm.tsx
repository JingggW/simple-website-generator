...
export const RequestForm = ({ title, description, fields, submitLabel, variant = "contact", imageName }: any) => {
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center py-12">
              <div className="mb-12">
                <h2 className="text-4xl md:text-6xl font-black text-foreground mb-6 uppercase tracking-tighter leading-none">{title}</h2>
                {description && <p className="text-xl text-secondary max-w-md leading-relaxed">{description}</p>}
              </div>
              <FormInner />
            </div>
          </div>
    ...
    <section>
      <div className="max-w-3xl mx-auto px-6">
        <div className="bg-foreground/[0.02] border border-foreground/5 rounded-[2.5rem] p-8 md:p-16 shadow-sm">
          <div className="mb-12">
            <h2 className="text-4xl font-black text-foreground mb-4 uppercase tracking-tighter leading-none">{title}</h2>
